...
public class MultipleResponseQnA implements ManyOfManyResponse, Parcelable {
    public static final Creator<MultipleResponseQnA> CREATOR =
            new Creator<MultipleResponseQnA>() {
    ...
    public MultipleResponseQnA(Parcel parcel) {
        ...
        parcel.readStringList(correctAnswers);
