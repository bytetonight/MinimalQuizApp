...
public class DualChoiceResponseQnA implements OneOfManyResponse, Parcelable {
    public static final Creator<DualChoiceResponseQnA> CREATOR =
            new Creator<DualChoiceResponseQnA>() {

                @Override
                public DualChoiceResponseQnA createFromParcel(Parcel source) {
                    return new DualChoiceResponseQnA(source);
                }

                @Override
                public DualChoiceResponseQnA[] newArray(int size) {
                    return new DualChoiceResponseQnA[size];
                }
            };
    ...
    public DualChoiceResponseQnA(Parcel parcel) {
        question = parcel.readString();
        answer = parcel.readString();
        parcel.readStringList(incorrectAnswers);
    }

    public DualChoiceResponseQnA(String question, List<IntStringPair> answers) {
