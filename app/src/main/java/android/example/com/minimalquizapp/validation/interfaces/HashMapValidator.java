...
package android.example.com.minimalquizapp.validation.interfaces;

import java.util.HashMap;


/**
 * Created by ByteTonight on 01.06.2017.
 */

public interface HashMapValidator extends Validator {
    boolean validate(HashMap<String, String> userAnswer);
}
